...
\thesisTitle{Konzeptionierung und Entwicklung eines Digitalen Zwillings für das Lauftraining mit einem Unbemannten Luftfahrzeug}
\thesisTitleEN{PLATZHALTER}

% text field
%-> replace the key words with your own key words
\keywordsDE{Digitaler Zwilling, Human-Drone Interaction, Quadrocopter, Unbemanntes Luftfahrzeugt, Jogging, Laufen}
\keywordsEN{Digital Twin, Human-Drone Interaction, Quadrocopter, Unmanned aerial vehicle, Jogging, Running}
