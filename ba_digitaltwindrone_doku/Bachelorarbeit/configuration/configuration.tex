...
\thesisTitle{Entwicklung eines Digitalen Zwilling Frameworks für unbemannte Luftfahrzeuge}
\thesisTitleEN{PLATZHALTER}

% text field
%-> replace the key words with your own key words
\keywordsDE{Digitaler Zwilling, Human-Drone Interaction, Quadrocopter, Unbemanntes Luftfahrzeug, Jogging, Laufen}
