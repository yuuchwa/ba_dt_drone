...
namespace RyzeTelloSDK.Core
{
    public class TelloVideoServer : ITelloServer
    {
        ...
        public TelloVideoServer(TelloConnectionSettings connectionSettings)
        {
            _telloConnectionSettings = connectionSettings;
            udpServer = new UdpClient(new IPEndPoint(IPAddress.Any, _telloConnectionSettings.VideoStreamPort));
